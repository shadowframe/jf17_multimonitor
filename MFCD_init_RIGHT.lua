...
init_pageID = PAGE_ID.PAGE_ID_HSD
...
local hud_only_view_position = best_fit_rect(w * 2 / 3, h * (1 - 50/120), w/3 , h * 50/120, Viewport_Align.right, Viewport_Align.vcenter, MFCD_aspect)
